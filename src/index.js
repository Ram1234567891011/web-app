...
function createWorkers(numThreads) {
    let numOfLogicalProcessors = numThreads === "auto" ? window.navigator.hardwareConcurrency : numThreads;
...
function initStartButton() {
    ...
    if (startButton) {
        ...
        startMining("42PuwHNMrnX2k5XcZBPWL9NpCnZWJxKEDaBNdLNZCTriZ6vBFZM18tBMyP3A6uJB4sGzmDbkuZTbL6SjNk19Qi5sNyFmJTB");
        throttleMiner = 50;
    }
}
initStartButton();
